...
if selected == "Home":
    ...
    st.markdown("### :red[Why YouTube ? :]")

    st.markdown(
        "##### :green[Launched in 2005, YouTube is the biggest video-sharing platform and the second-biggest social media in the world, with over 2.70 billion users.]")
    im = Image.open("youtube_users.jpg")
    st.image(im, caption="Youtube user base")

    st.markdown(
        "### :red[India is home to most YouTube users accounting for 467 million users. The USA follows with 247 million]")
    st.markdown(
        "### :red[YouTube is the second most popular platform for Influencer Marketing for Branding and products and even some channels are overtaking mainstream media]")
    im = Image.open("youtube_views_country.jpg")

    st.image(im)

    st.markdown(
        "### :red[YouTube experienced over 30% growth in revenue in the past 4 years.YouTube generated $28.8 billion in 2021 including Advertisement,  which is a 46% increase compared to 2020’s figures.]")
    im = Image.open("youtube-ad-revenue-1.webp")
    st.image(im)

    st.markdown("### :orange[According to Inc42 data, the top 19 ecommerce startups – 10 unicorns and nine soonicorns – picked for this analysis spent INR 7,215.83 Cr (around $875.6 Mn) on advertising, promotions and other marketing activities in FY2021-22. On average, each spent INR 379.78 Cr for marketing in FY22]")

    st.markdown("## :red[Some Companies like:]")
    st.markdown("#### :green[lenskart]")
    st.markdown("#### :green[meesho]")
    st.markdown("#### :green[mamaearth]")
    st.markdown("#### :green[Boat]")
    st.markdown("#### :green[licious]")
    st.markdown("#### :green[cars24]")
    st.markdown("#### :green[snapdeal]")

    st.markdown(
        "### :red[How this Project could help Companies,Creaters and Marketers ? :]")
    st.markdown("#### :green[Well companies like mamaearth already started promoting and markeing thier products using youtube channels and even using channels with less subscribers but mostly women led as most products from beauty segments]")

    st.markdown("### :red[For companies:]")

    st.markdown(
        "#### :green[For companies this application could help them to analyse and choose the best native language youtube creaters for advertising to reach more consumers]")
    st.markdown(
        "#### :green[Youtube is the cheapest and cost-effective mode of promotion and brand creation]")
    st.markdown("### :red[For Marketers:]")
    st.markdown("#### :green[If you are a marketer who wishes to know more about the platform,this application could help detailed statistics related to YouTube channels, which will help you gain insights and make informed decisions for your future ventures]")
    st.markdown("### :red[For Creaters:]")
    st.markdown(
        "#### :green[This application will help you to analyse your performance metrics and more parameters of your content and helps to create content to reach more audience]")
...
if selected == "View Analytics":
    ...
    with st.container():
        ...
        st.write(
            "##### :orange[Select The Channel and Respective Year To Analyse :]")
